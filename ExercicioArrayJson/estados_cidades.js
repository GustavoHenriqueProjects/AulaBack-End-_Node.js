...
const getDadosEstado = function($UF){
   ...
   const dadosEstadosArray = [] //
   
   estadosCidades.estados.forEach(function(dadosEstado){

      if(dadosEstado.sigla == uf){
      /**Adicionando os dados do estado selecionado**/
      dadosEstadosJson.uf = dadosEstado.sigla
      dadosEstadosJson.uf = dadosEstado.nome
      // dadosEstadosArray.capital(dadosEstado.capital)
      // dadosEstadosJson.uf = dadosEstadosArray

      // dadosEstadosArray.regiao(dadosEstado.regiao)
      // dadosEstadosJson.uf = dadosEstadosArray
