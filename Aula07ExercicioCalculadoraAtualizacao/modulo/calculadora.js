...
const calculoTabuada = function ($tabuadaInicial, $tabuadaFinal, $tabuadaInicialMultiplicador, $tabuadaFinalMultiplicador) {
    ...
    //For responsavel por Defenir o multiplicador de toda a tabuada inicial ate a tabuada final(Multiplicador)
    for (let tabuadaContinuacao = tabuadaInicial; tabuadaContinuacao <= tabuadaFinal; tabuadaContinuacao++) {

        //for responsavel por mostra o calculo de todas as tabuadas
        for (let multiplicando = tabuadaInicialMultiplicador; multiplicando <= tabuadaFinalMultiplicador; multiplicando++) {

            produto = tabuadaContinuacao * multiplicando
            console.log(`${tabuadaContinuacao} X ${multiplicando} = ${produto}`)
